...
from attacks.projectile import Projectile, ArcProjectile, Toss
from attacks.blast import Blast
from attacks.melee import Melee
from attacks.sonicStun import SonicStun
...
class AttackFactory(object):
    ...
    def makeSonicStun(self):
        return SonicStun(self.attacker)

# List of special attacks corresponding to different bandmembers.
specialsList = [lambda a: Blast(a),
                lambda a: Toss(a),
                lambda a: SonicStun(a)]
